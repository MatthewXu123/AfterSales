$(function() {
	...
	$("#btn_delete").click(function() {
		if (confirm("确认要删除issue和相应维修记录吗？")) {
			...
			$.ajax({
				type : "post",
				url : "/aftersales/dm_issue/delete",
				data : {
					"ids": ids,
				},
				dataType : 'JSON',
...
var TableInit = function() {
	...
	oTableInit.Init = function() {
		$('#table').bootstrapTable({
			url : '/aftersales/dm_issue/list', // 请求后台的URL（*）
